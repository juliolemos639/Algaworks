...
INSERT INTO pessoa (nome, logradouro, numero, complemento, bairro, cep, cidade, estado, ativo) values ('Julio Santos', 'Rua do Nada', '4566', null, 'Segismundo Moura', '28.630-00', 'Nova Friburgo', 'RJ', true);